...
In BitShares, you can create an account relatively easily by using the BitShares UI wallet. It's important to know that only you know your password, and no one can recover it. So, we recommend you to read through BitShares Accounts information. When you created BitShares account, you also create your account's public keys and private keys. There are three types of keys in your wallet. Please read a [Permissions](/bbf/user_guide/accounts/permissions.md#permissions) section to get more information. 

### [Account](/bbf/user_guide/accounts/README.md#account-1)
